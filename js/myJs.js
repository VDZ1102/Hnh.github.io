const textConfig = {
  ...
  text9: "Năm mới 2023 chúc Chutichacademy mãi keo và bạn Hoàng Hà học tập mãi đỉnh tánh bớt chua ngoa gặp nhiều may mắn nhé :)) 🤗 🤗 🤩 🤩", // mỗi bạn một câu chúc riêng đừng lộn
...
$(document).ready(function () {
  ...
  function firstQuestion() {
    ...
    Swal.fire({
      ...
      imageUrl: "img/Hnh.jpg",    //ảnh pop up đầu
      imageWidth: 300,
      imageHeight: 450,
